...
<html lang="en">
   ...
   <body>
      ...
      <br>
      <br>
      <form action="results1.php" method="get" autocomplete="on">
         <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
               <div class="input-group">
      ...
      <div class="row" style="text-align: center">
         <div class="container initial">
            <div class="panel panel-success">
               ...
               <!-- <input method= "POST" id="<?php echo $r['_id']; ?>" type="submit" class="btn btn-success save" value="Login to Save" style="
                  background-color: skyblue;"> -->
               <input class="btn btn-success save" id="<?php echo $r['_id']; ?>"  data-toggle="modal" href="javascript:void(0)" onclick="openLoginModal();" value= "Save" style="
                  background-color: skyblue;">
               <br>
               <br>
            </div>
      ...
      <nav aria-label="...">
         <ul class="pagination">
            <?php
               ...
               ?>
            <li class="page-item"><a class="page-link searchresult1" id="<?php echo $q ?>" href="#" value=<?php echo $i?>><?php echo $i ?></a></li>
            <?php       
               }
